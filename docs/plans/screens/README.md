...
|---|-----------|---------|-------------|
| 1 | [01-app-shell/](01-app-shell/) | 1 | Splash screen — proves routing works end-to-end |
| 2 | [02-auth/](02-auth/) | 4 | Auth entry, login, sign up, login prompt sheet — must work before any protected screen |
